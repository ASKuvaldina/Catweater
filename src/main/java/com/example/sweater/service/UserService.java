...
public class UserService implements UserDetailsService {
    ...
    private void sendMessage(User user) {
        if (!StringUtils.isEmpty(user.getEmail())) {
            String message = String.format(
                    "Hello, %s! \n" +
                            "Welcome to Catweater. Please, visit next link: http://localhost:8080/activate/%s",
                    user.getUsername(),
    ...
    public void updateProfile(User user, String password, String email, String dopInfo,
        ...
        if (!StringUtils.isEmpty(dopInfo)) {
            user.setDopInfo(dopInfo);
        }
